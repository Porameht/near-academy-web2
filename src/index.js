...
const memeContractsInitButton = document.querySelector(
  "#meme-contracts-init-button"
);
const memeContractsInitLabel = document.querySelector(
  "#meme-contracts-init-label"
);
...
const getRecentCommentsButton = document.querySelector(
  "#get-recent-comments-button"
);

const memeSelectElement = document.getElementById("meme-select");
const submitCommentSelectElement = document.getElementById(
  "submit-comment-select"
);
const recentCommentSelectElement = document.getElementById(
  "recent-comments-select"
);
